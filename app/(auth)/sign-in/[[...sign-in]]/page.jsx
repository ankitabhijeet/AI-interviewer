...
export default function Page() {
  return (<div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="bg-muted relative hidden lg:block">
        ...
        <img
          src="https://images.unsplash.com/photo-1680783954745-3249be59e527?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Image"
